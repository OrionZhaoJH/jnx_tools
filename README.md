...
| JNB 工具 | JNB 系列：单通道 24 字节协议（状态/时间/T1/T2 双结果/计时/加样/完成/版本号/C/T_2/B/T_1 实时/蓝牙确认），FFE2 仅保留重启/关机 | [JNB_Tool.html](JNB_Tool.html) |
...
- [JNB_Tool.html](JNB_Tool.html) ：JNB 工具（24 字节协议，FFE2 仅重启/关机）
